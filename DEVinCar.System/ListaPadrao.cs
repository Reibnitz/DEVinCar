...
namespace DEVinCar.System
{
    public class ListaPadrao
    {
        internal static void CriarLista(VeiculoFactory veiculoFactory)
        {
            ...
            IVeiculo camionete1 = veiculoFactory.CriarCamionete(4, 40, 130, "Gasolina", "Saveiro", "CAM-0001", 80000, "Branca", DateTime.Now);
            IVeiculo camionete2 = veiculoFactory.CriarCamionete(4, 40, 130, "Diesel", "Saveiro", "CAM-0001", 80000, "Branca", DateTime.Now);
            IVeiculo camionete3 = veiculoFactory.CriarCamionete(4, 40, 130, "Diesel", "Saveiro", "CAM-0001", 80000, "Branca", DateTime.Now);
